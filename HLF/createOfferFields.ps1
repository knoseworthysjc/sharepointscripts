...
Connect-PnPOnline -Url https://sjccontent.sharepoint.com/teams/SJCHLFContentAdmin
<#
...
Add-PnPTaxonomyField -Group "Offer Management" -DisplayName "Page From" -InternalName "pagefrom" -TermSetPath "HLF TermStore|Campaign Management|Pages"
